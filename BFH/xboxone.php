<?php 
    ...
    $_GET['user'];
    $streamer = $_GET['user'];
    $url = "http://api.bfhstats.com/api/playerInfo?plat=xone&name=$streamer&opt=stats,extra";
    ...
    $rankscore = $json['stats']['scores']['rankScore'];
    $combatscore = $json['stats']['scores']['combatScore'];
    $skill = $json['stats']['skill'];
    $kills = $json['stats']['kills'];
    $wins = $json['stats']['numWins'];
    $lost = $json['stats']['numLosses'];
    $killassists = $json['stats']['killAssists'];
?>
...
<head>
    ...
    <title>BattleField Hardline API - Xbox ONE</title>
...
<div class="container">
    ...
    <div class="center">
        ...
        <div style="margin-top: 5em">
            ...
            <h2>BattleField Hardline API</h2>
